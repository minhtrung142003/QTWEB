...
import unity1 from "@assets/solution/Group 9.png";
import webd from "@assets/solution/webd.png";

export const items = [
    { src: window1, text: "Window Application" },
    { src: macs, text: "MacOS IOS" },
    { src: virutal, text: "Window Application" },
    { src: augmented, text: "Augmented Reality" },
    { src: laptop, text: "Website" },
    { src: subtract, text: "Android" }
  ];

export const content2 = [
    { src: unreal, text: "Unreal Engine" },
    { src: unity1, text: "Unity Engine" },
    { src: webd, text: "Web development" }
];