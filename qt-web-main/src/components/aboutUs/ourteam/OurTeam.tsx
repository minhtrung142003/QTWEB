...
const OurTeam: React.FC = () => {
  return (
    <div className="container w-full h-full">
      <div className="w-full h-full grid grid-cols-6 gap-x-2 md:py-40 xl:py-36 2xl:py-32 px-10 mt-[-5%]">
          ...
          <div
            ...
            className={`md:w-full xl:w-[90%] h-full flex-col col-span-1 border-2 border-[#945C3C] rounded-lg  bg-[#CDCDCE] 
              ${index !== 0 ? 'organe-shadow-extra' : 'organe-shadow'}
                          flex justify-center md:px-5 xl:px-8 md:py-6 xl:py-8 2xl:py-9 ${
                            index % 2 !== 0 ? "mt-[30px] " : ""
      ...
      <div className="flex justify-center items-center md:my-[-6%] xl:my-[-3%] 2xl:my-[-2%]">
        <p className="text-[20px] font-normal text-[#333333] capitalize">
