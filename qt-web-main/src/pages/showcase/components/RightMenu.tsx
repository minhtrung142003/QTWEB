    ...
    return (
        <>
            <div className="absolute mr-3 w-[11rem] h-[75%] flex flex-col right-0 top-[13%] bg-opacity-50 p-2 bg-black rounded-2xl">
                ...
                <div className="max-h-[90%]  bg-opacity-50 bg-black mt-2 w-full h-full rounded-2xl grow-1 overflow-auto  showcase-menu-right">
                    {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((index) => (
                        <div
                            key={index}
                            className="w-full h-[20%] rounded-2xl mb-2 cursor-pointer "
                        >
                            <img
                                src={House7}
