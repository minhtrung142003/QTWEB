...
const ItemDate: React.FC = () => {
  return (
    <div className="flex md:max-xl:pt-1 xl:max-xxxl:pt-3 pt-8 font-bold md:max-xl:text-base text-xl w-full justify-center md:max-lg:-translate-y-80 md:max-lg:px-14">
